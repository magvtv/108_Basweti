export default function Footer() {
  return (
    <footer className="py-10 border-t border-[var(--border-subtle)] bg-[var(--bg-base)] no-print">
      <div className="max-w-5xl mx-auto px-4 md:px-8 flex flex-col items-center gap-3 text-center">
        <p className="font-serif italic text-[var(--text-primary)] text-lg">Peris Basweti</p>
        <p className="text-xs tracking-widest text-[var(--accent-bronze)]">1931 &mdash; 2026</p>
